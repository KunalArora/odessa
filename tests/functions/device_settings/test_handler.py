...
class TestHandler(TestCase):
    def setUp(self):
        environ['BOC_API_CALL_TIMEOUT'] = '180'
        environ['DEFAULT_BOC_SERVICE_ID'] = '2'
        environ['BOC_BASE_URL'] = 'https://dev-connections.mysora.net'
        logging.getLogger('device_settings').setLevel(100)
